...
class PayrollCompanyConfig extends Model implements Auditable
{
    ...
    protected $fillable = [
        ...
        'gl_wages_expense_account_admin', 'gl_wages_expense_account_drivers',
        'gl_nssa_liability_account', 'gl_paye_liability_account',
        'gl_pension_liability_account', 'gl_nec_liability_account',
        'gl_nssa_employer_expense_account_admin', 'gl_nssa_employer_expense_account_drivers',
        'gl_nec_employer_expense_account_admin', 'gl_nec_employer_expense_account_drivers',
        'gl_pension_employer_expense_account_admin', 'gl_pension_employer_expense_account_drivers',
        'gl_nssa_employee_liability_account', 'gl_aids_levy_liability_account',
        'gl_payroll_suspense_account', 'gl_wages_payable_account',
        'split_payroll_expenses_by_employee_type',
    ...
    protected $casts = [
        ...
        'split_payroll_expenses_by_employee_type' => 'boolean',
        'active'                                 => 'boolean',
        'effective_from'                         => 'date',
        'effective_to'                           => 'date',
    ];

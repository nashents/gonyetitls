...
class VehicleFuelExport implements FromQuery,
ShouldAutoSize,
WithMapping,
WithHeadings,
WithEvents,
...
WithCustomStartCell
{
    ...
    */
    ...
    {
        return Fuel::query()->with(['container','vehicle',
        'vehicle.vehicle_make','vehicle.vehicle_model'])->where('vehicle_id',$this->vehicle_id)

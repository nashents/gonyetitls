...
class ConsigneesExport implements  FromQuery,
ShouldAutoSize,
WithMapping,
WithHeadings,
WithEvents,
...
WithCustomStartCell
{
    ...
    */
    ...
    public function map($consignee): array{
            ...
            $street_address =  $consignee->street_address ?: "";
            $address = $street_address." ".$suburb." ".$city." ".$country;
            $vat = $consignee->vat_number ?: "";
            $tin = $consignee->tin_number ? " | ".$consignee->tin_number : "";
            return   [
                $consignee->name,
                $consignee->phonenumber,
                $consignee->worknumber,
                $consignee->email,
                $vat."".$tin,
                $address
            ];

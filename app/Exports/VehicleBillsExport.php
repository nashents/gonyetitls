...
class VehicleBillsExport implements FromQuery,
ShouldAutoSize,
WithMapping,
WithHeadings,
WithEvents,
...
WithCustomStartCell
{
    ...
    */
    ...
    {
        return Bill::query()->with('vendor','container', 'trailer', 'fuel','transporter','invoice','ticket','purchase')->where('vehicle_id',$this->vehicle_id)

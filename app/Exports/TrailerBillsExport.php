...
class TrailerBillsExport implements FromQuery,
ShouldAutoSize,
WithMapping,
WithHeadings,
WithEvents,
...
WithCustomStartCell
{
    ...
    */
    ...
    {
        return Bill::query()->with('vendor','container', 'trailer', 'fuel','transporter','invoice','ticket','purchase')->where('trailer_id',$this->trailer_id)

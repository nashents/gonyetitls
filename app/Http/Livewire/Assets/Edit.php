...
class Edit extends Component
{
    ...
    public function mount($asset){
        ...
        $this->expense_accounts = Account::selectable($asset->account_id)->whereHas('account_type.account_type_group', function ($query) {
            return $query->where('name','Expenses');
        })->orderBy('name','asc')->get();
        $this->income_accounts = Account::selectable($asset->account_id)->whereHas('account_type', function($q){
            $q->where('name', 'Income');
         })->orderBy('name','asc')->get();

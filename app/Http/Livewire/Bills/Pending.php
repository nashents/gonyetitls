   ...
   public function getBillsProperty(){
    ...
    if (in_array('Admin', $role_names) || in_array('Super Admin', $role_names)) {
        ...
        elseif (isset($this->search)) {
            ...
            return Bill::query()->with('invoice','transporter','container','top_up','trip','horse','driver','purchase','currency','payments')->where('authorization','pending')->whereMonth($this->bill_filter, date('m'))

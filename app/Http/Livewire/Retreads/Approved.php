        ...
        if (isset($this->from) && isset($this->to)) {
            if (isset($this->search)) {
                return view('livewire.retreads.approved',[
                    'retreads' => Retread::query()->with('currency','vendor','account','retread_tyres')->where('authorization','approved')->whereBetween($this->retread_filter,[$this->from, $this->to] )
                ...
                return view('livewire.retreads.approved',[
                    'retreads' => Retread::query()->with('currency','vendor','account','retread_tyres')->where('authorization','approved')->whereBetween($this->retread_filter,[$this->from, $this->to] )->orderBy('retread_number','desc')->paginate(10),
                    'retread_filter' => $this->retread_filter,
                ]);
            }

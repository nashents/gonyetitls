...
class Edit extends Component
{
    ...
    public function mount($product){
        $this->income_accounts = Account::selectable($product->account_id)->whereHas('account_type', function($q){
            $q->where('name', 'Income');
         })->orderBy('name','asc')->get();

        $this->expense_accounts = Account::selectable($product->expense_account_id)->whereHas('account_type.account_type_group', function($q){
        ...
        $this->tax_account_id = $product->tax_id;

...
namespace App\Http\Livewire\Reports\AgedReceivables;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        if (isset($this->as_of_date)) {
            $calculator = new AgedReceivablesCalculator($this->as_of_date, $this->default_currency_id);
            [$this->customer_rows, $this->grand_totals] = $calculator->byCustomer();
        }

        return view('livewire.reports.aged-receivables.index');
    }
}

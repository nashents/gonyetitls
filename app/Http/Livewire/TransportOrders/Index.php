...
class Index extends Component
{
    ...
    public function mount(){
      ...
      protected $rules = [
          ...
          'freight' => 'required',
          'start_date' => 'required',
          'manifest_number' => 'nullable|unique:transport_orders,manifest_number,NULL,id,deleted_at,NULL|string',
          'cd3_number' => 'nullable|unique:transport_orders,cd3_number,NULL,id,deleted_at,NULL|string',
          'cd1_number' => 'nullable|unique:transport_orders,cd1_number,NULL,id,deleted_at,NULL|string',
          'bill_of_entry' => 'nullable|unique:transport_orders,bill_of_entry,NULL,id,deleted_at,NULL|string',

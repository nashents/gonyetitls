...
class Rejected extends Component
{
    ...
    public function mount(){
        ...
        if (isset( $period)) {
            if ($period != "all") {
                $this->transporters = Transporter::where('authorization', 'rejected')->whereYear('created_at',$period)->latest()->get();
            }else {
                $this->transporters = Transporter::where('authorization', 'rejected')->latest()->get();
            }
        }
    ...
    {
        $this->transporters = Transporter::where('authorization', 'rejected')->latest()->get();
        return view('livewire.transporters.rejected',[

...
class Index extends Component
{
    ...
    public function store(){
        ...
        DB::transaction(function () {
            ...
            $rate->from = $this->from;
            $rate->to = $this->to;
            $rate->customer_id = $this->customer_id ?: Null;
            $rate->transporter_id = $this->transporter_id ?: Null;
            $rate->loading_point_id = $this->loading_point_id ?: Null;
            $rate->offloading_point_id = $this->offloading_point_id ?: Null;
            $rate->currency_id = $this->currency_id ?: Null;
            $rate->cargo_id = $this->selectedCargo ?: Null;
            $rate->rate = $this->rate;

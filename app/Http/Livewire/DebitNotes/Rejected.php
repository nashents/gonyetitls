...
class Rejected extends Component
{
    ...
    public function mount(){
        ...
        if (isset( $period)) {
            if ($period != "all") {
                $this->debit_notes = DebitNote::where('authorization', 'rejected')->whereYear('created_at',$period)->latest()->get();
            }else {
                $this->debit_notes = DebitNote::where('authorization', 'rejected')->latest()->get();
            }
        }
    ...
    public function authorize($id){
      ...
      try{
        ...
        if ($this->authorize == "approved") {
            ...
            $this->dispatchBrowserEvent('alert',[
                'type'=>'success',
                'message'=>"Debit Note Rejected Already"
            ]);
    ...
    {
        $this->debit_notes = DebitNote::where('authorization', 'rejected')->latest()->get();
        return view('livewire.debit-notes.rejected',[

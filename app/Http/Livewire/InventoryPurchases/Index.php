...
class Index extends Component
{
    ...
    public function mount($category){
            ...
            $this->products = Product::orderBy('name','asc')->where('status',True)->where('buy',True)->get();
    ...
    public function store(){
        ...
        $purchase->status = '1';
        $purchase->expiry = Carbon::parse($this->date)->addDays(7);
        $purchase->save();
    ...
    public function render()
    {
        ...
        if (isset($this->from) && isset($this->to)) {
            if (isset($this->search)) {
                ...
                return view('livewire.inventory-purchases.index',[
                    'purchases' => Purchase::query()->with('vendor','purchase_products','purchase_products.product')->where('department',$this->department)->whereBetween($this->purchase_filter,[$this->from, $this->to] )->orderBy('created_at','desc')->paginate(10),
                ]);
            }
        ...
        elseif (isset($this->search)) {
            ...
            return view('livewire.inventory-purchases.index',[
                ...
                ->whereYear($this->purchase_filter, date('Y'))->orderBy('created_at','desc')->paginate(10),
            ]);

    ...
    protected $messages =[
      ...
      public function updateAuthorization(){
        ...
        if ($this->authorize == 'approved') {  
            ...
            $gate_pass->user_id = $this->user->id;
            $gate_pass->gate_pass_number = $this->gate_passNumber();
            if ($this->employee->branch) {
                $gate_pass->branch_id = $this->employee->branch ? $this->employee->branch->id : "";
            }
            $gate_pass->type = "Trip";
            ...
            if($expenses->count()>0){
                    ...
                    if(isset($trip_expense->fuel_id)){
                        ...
                        if (isset($fuel)) {
                            ...
                            if (isset($fuel->container)) {
                                    ...
                                    $bill->authorized_by_id = $this->user->id;
                                    $bill->authorization = $this->authorize;
                                    $bill->comments = $this->comments;
                                    $bill->save();
                
                                    $bill_expense = new BillExpense;
                                    $bill_expense->user_id = $this->user->id;
                        ...
                        $account = Account::where('name','Creditor Payment')->get()->first();
                ...
                $transport_order->user_id = $this->user->id;
                ...
                $transport_order->authorized_by = $this->employee->name . ' ' .$this->employee->surname;
                ...
                $auth_name = $this->employee->name;
                $auth_surname =$this->employee->surname;
                ...
                if ( isset($this->loading_point_email) && $this->loading_point_email != "") {
                    $data = array(
                       ...
                       Mail::to($this->loading_point_email)->send(new TransportOrderMail($data, $this->company));
                }
                ...
                if ($this->trip->fuel_order == True) {
                    ...
                    $fuel->authorized_by_id = $this->user->id;
                    ...
                    if ($this->authorize == "approved") {
                        ...
                        $this->authorized_by = $this->employee->name . ' ' . $this->employee->surname;
                        ...
                        $data = array(
                           ...
                           Mail::to($this->fuel_station_email)->send(new FuelOrderMail($data, $this->company));
                        }

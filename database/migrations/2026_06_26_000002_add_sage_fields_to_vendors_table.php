...
class AddSageFieldsToVendorsTable extends Migration
{
    /**
     * Run the migrations.
     *
     * Adds Sage Intacct sync-state columns to vendors and backfills any record
     * that already exists in Sage (identified by a non-empty custom_ref, which
     * the bulk-import from Sage populates with the Sage VENDORID).
     *
     * @return void
     */
    public function up()
    {
        ...
        // Backfill: vendors imported from Sage already carry the Sage ID in

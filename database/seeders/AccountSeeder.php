...
class AccountSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //    //Liabilities
            ...
            [ 'currency_id' => Null, 'account_type_group_id' =>  $customer_prepayments_customer_credits->account_type_group->id,'account_type_id' => $customer_prepayments_customer_credits ? $customer_prepayments_customer_credits->id : "",'name' => 'Customer Advances','abbreviation' => '','rate' => '', 'description' => "Amounts invoiced to customers in advance of the related trip being completed. Unlike Customer Deposits (actual cash received), this represents revenue billed but not yet earned - a liability until the trip reaches Offloaded status, at which point it is reclassified to Sales (and VAT Payable).", 'hs_code' => ''],

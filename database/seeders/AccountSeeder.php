...
class AccountSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //    //Liabilities
            ...
            [ 'currency_id' => Null, 'account_type_group_id' =>  $sales_taxes->account_type_group->id,'account_type_id' => $sales_taxes ? $sales_taxes->id : "",'name' => 'Value Added Tax 15%','abbreviation' => 'VAT 15%','rate' => '15','description' => '', 'hs_code' => '99001000' ],
            [ 'currency_id' => Null, 'account_type_group_id' =>  $sales_taxes->account_type_group->id,'account_type_id' => $sales_taxes ? $sales_taxes->id : "",'name' => 'Value Added Tax 0%','abbreviation' => 'VAT 0%','rate' => '0','description' => '', 'hs_code' => '99002000' ],
            [ 'currency_id' => Null, 'account_type_group_id' =>  $sales_taxes->account_type_group->id,'account_type_id' => $sales_taxes ? $sales_taxes->id : "",'name' => 'Value Added Tax Exempt','abbreviation' => 'VAT Exempt','rate' => '0','description' => '', 'hs_code' => '99003000' ],

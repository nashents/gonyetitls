<div data-backdrop="static" data-keyboard="false" class="modal fade" id="allowanceDeleteModal{{ $allowance->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Allowance?</strong> </center> 
            </div>

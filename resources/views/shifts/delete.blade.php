<div data-backdrop="static" data-keyboard="false" class="modal fade" id="shiftDeleteModal{{ $shift->id }}" tashiftdex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Shift?</strong> </center> 
            </div>

<div data-backdrop="static" data-keyboard="false" class="modal fade" id="salary_itemDeleteModal{{$salary_item->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Salary Item?</strong> </center> 
            </div>
            <form method="POST" action="{{route('salary_items.destroy', $salary_item->id)}}">
                {{ csrf_field() }}

<div data-backdrop="static" data-keyboard="false" class="modal fade" id="fuel_requestDeleteModal{{ $fuel_request->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Fuel Request?</strong> </center>
            </div>
            <form action="{{route('fuel_requests.destroy', $fuel_request->id)}}" method="POST" >
                {{ csrf_field() }}

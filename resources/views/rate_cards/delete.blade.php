<div data-backdrop="static" data-keyboard="false" class="modal fade" id="rate_cardDeleteModal{{ $rate_card->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Rate?</strong> </center> 
            </div>
            <form action="{{route('rate_cards.destroy', $rate_card->id)}}" method="POST" >
                {{ csrf_field() }}

<div data-backdrop="static" data-keyboard="false" class="modal fade" id="loading_pointDeleteModal{{ $loading_point->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Loading Point?</strong> </center>
            </div>
            <form action="{{route('loading_points.destroy', $loading_point->id)}}" method="POST" >
                {{ csrf_field() }}

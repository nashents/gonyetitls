  ...
  <div class="sidebar-content">
      ...
      <div class="sidebar-nav">
          <ul class="side-nav color-gray">
              ...
              <li class="{{ request()->routeIs('reminders.index') ? 'active' : '' }}"><a href="{{route('reminders.index')}}" ><i class="fa fa-bell"></i><span>Reminders</span></a></li>
              ...
              <li class="has-children">
                  ...
                  <ul class="child-nav">
                      ...
                      <li class="{{ request()->routeIs('salary_items.index') ? 'active' : '' }}"><a href="{{route('salary_items.index')}}"><i class="fas fa-list"></i> <span>Salary Items</span></a></li>
                  </ul>
              </li>
             @endif
              @php
              ...
              <li class="has-children {{ request()->routeIs('loans.*') ? 'active' : '' }}" >
                  ...
                  <ul class="child-nav">
                      <li><a href="{{route('loans.myloans')}}"><i class="fas fa-list "></i> <span>My Applications</span></a></li>
                      ...
                      <li><a href="{{route('loans.index')}}"><i class="fas fa-list "></i> <span>All Loans</span></a></li>
              ...
              {{-- <li class="has-children">
                  <a href="#"><i class="fas fa-hand-holding-usd"></i> <span>Sales</span> <i class="fas fa-angle-right arrow"></i></a>
                  <ul class="child-nav">
                      <li><a href="{{route('sales.create')}}" ><i class="fas fa-plus "></i> <span>Create Sale</span></a></li>
                      <li><a href="{{route('sales.index')}}" ><i class="fas fa-list "></i> <span>Manage Sales</span></a></li>
                  </ul>
              </li> --}}
              {{-- <li class="has-children">
              ...
              <li class="{{ request()->routeIs('cashflows.index') ? 'active' : '' }}"><a href="{{route('cashflows.index')}}"><i class="fas fa-money-check"></i> <span>Transactions</span></a></li>
             ...
             //  ->where('created_at', '<', \Carbon\Carbon::now()->endOfWeek())->get()->count();
              ...
              <li class="has-children {{ request()->routeIs('fuel_requests.*') ? 'active' : '' }}" >
                  ...
                  <li class="has-children"  >
                      <a href="#"><i class="fas fa-door-open"></i> <span>Gatepass</span> <i class="fas fa-angle-right arrow"></i></a>
                      <ul class="child-nav">
                          <li class="{{ request()->routeIs('gate_passes.pending',['department'=>'logistics']) ? 'active' : '' }}"><a href="{{route('gate_passes.pending',['department'=>'logistics'])}}" ><i class="fas fa-clock-o "></i> <span>Pending Gatepasses</span>
                              @if ($gate_passesPendingCount>0)
                              <span class="label label-success ml-5">{{$gate_passesPendingCount}}</span>
                              @endif
                          </a></li>
              ...
              <li class="has-children">
                  <a href="#"><i class="fas fa-door-open"></i> <span>Gatepass</span> <i class="fas fa-angle-right arrow"></i></a>
                  <ul class="child-nav">
                      <li class="{{ request()->routeIs('gate_passes.pending',['department'=>'workshop']) ? 'active' : '' }}"><a href="{{route('gate_passes.pending',['department'=>'workshop'])}}" ><i class="fas fa-clock-o "></i> <span>Pending Gatepasses</span>
                          @if ($gate_passesPendingCount>0)
                          <span class="label label-success ml-5">{{$gate_passesPendingCount}}</span>
                          @endif
                      </a></li>
              ...
              @endphp
                  <li class="has-children {{ request()->routeIs('retreads.*') ? 'active' : '' }}" >
                      ...
                      <ul class="child-nav">
                          ...
                          @if (in_array('Management', $rank_names) || isset($wsdepartment_head) || isset($stdepartment_head) || in_array('Super Admin', $role_names))
                          <li>
                              <a href="{{route('retreads.pending')}}" ><i class="fas fa-clock-o "></i> <span>Pending Retreads</span>
              ...
              @endif
                      ...
                      <li class="{{ request()->routeIs('profile',Auth::user()->id) ? 'active' : '' }}">

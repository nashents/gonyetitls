        ...
        <table id="payroll_salariesTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach ($payroll_salaries as $payroll_salary)
                  @if ($payroll_salary->salary)
                    <tr>
                        <td>{{$payroll_salary->salary->employee ? $payroll_salary->salary->employee->name : ""}} {{$payroll_salary->salary->employee ? $payroll_salary->salary->employee->surname : ""}}</td>
                        <td>
                        ...
                        <td class="w-10 line-height-35 table-dropdown">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('payslips.preview', $payroll_salary->id) }}"><i class="fa fa-file color-success"></i>Payslip</a></li>
                                </ul>
                            </div>

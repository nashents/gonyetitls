                            ...
                            @if (Auth::user()->employee->department_head)
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><span class="badge bg-{{($leave->hod_decision == 'approved') ? 'success' : (($leave->hod_decision == 'rejected') ? 'danger' : 'warning') }}">{{($leave->hod_decision == 'approved') ? 'approved' : (($leave->hod_decision == '0') ? 'rejected' : 'pending') }}</span></td>

<div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title">
                                <a href="#" data-toggle="modal" data-target="#inspection_typeModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Inspection Item</a>
                            </div>
                        </div>
                                    ...
                                    <td class="w-10 line-height-35 table-dropdown">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#"  wire:click="edit({{$inspection_type->id}})" ><i class="fa fa-edit color-success"></i> Edit</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#inspection_typeDeleteModal{{ $inspection_type->id }}" ><i class="fa fa-trash color-danger"></i>Delete</a></li>
                                            </ul>
                                        </div>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="inspection_typeEditModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">

                        ...
                        <div class="panel-body">
                            ...
                            <form wire:submit.prevent="store()" class="p-20" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" wire:model.debounce.300ms="category" value="Other"  class="line-style"  required/>
                                            <label for="one" class="radio-label">Other Incident</label>
                                            <input type="radio" wire:model.debounce.300ms="category" value="Trip"  class="line-style" required/>   
                                            <label for="one" class="radio-label">Trip Incident</label>    
                                        </div>
                                    </div>
                                </div>

                                @if (isset($category) && $category == "Trip")
                                    <input type="checkbox" wire:model.debounce.300ms="create_trip"   class="line-style" />
                                    <label for="one" class="radio-label">Add trip details manually</label>
                                    @if ($create_trip == False)
                                        <div class="form-group">
                                           
                                            <label for="exampleInputEmail13">Trips</label>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                         <div class="form-group">
                                            <label for="exampleInputEmail13">Employees</label>
                                            <input type="text" wire:model.debounce.300ms="searchEmployee" placeholder="Search employee..." class="form-control" >
                                            <select wire:model.debounce.300ms="employee_id" class="form-control"   size="4">
                                                <option value="">Select Employee</option>
                                                @foreach ($employees as $employee)
                                                    <option value="{{$employee->id}}">{{ucfirst($employee->name)}} {{ucfirst($employee->surname)}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="injuriesRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                     @endforeach
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="injuriesAdd({{$k}})"> <i class="fa fa-plus"></i> Injury</button>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="damagesRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="damagesAdd({{$d}})"> <i class="fa fa-plus"></i> Damage</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail13">Incident Type</label>
                                                    <select wire:model.debounce.300ms="other_type.0" class="form-control"  >
                                                        <option value="">Select Incident Type</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail13">Incident Type</label>
                                                    <select wire:model.debounce.300ms="other_type.{{ $value }}" class="form-control"  >
                                                        <option value="">Select Incident Type</option>
                                                        <option value="LTI">LTI (Lost Time Injury)</option>
                                                        <option value="RTA">RTA (Road Traffic Accident)</option>
                                                        <option value="MTC">MTC (Medical Treatment Case)</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="othersRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="othersAdd({{$p}})"> <i class="fa fa-plus"></i> Other</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" wire:model.debounce.300ms="immediate_cause_id.0">
                                             ...
                                             <small>  <a href="{{ route('losses.index') }}" target="_blank"><i class="fa fa-plus-square-o"></i> New Loss Cause</a></small> <a href="#" wire:click.prevent="refresh('losses')" style="float: right"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="immediateRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="immediateAdd({{$r}})"> <i class="fa fa-plus"></i> Immediate Cause</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="basicRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="basicAdd({{$z}})"> <i class="fa fa-plus"></i> Basic Cause</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="contactsRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="contactsAdd({{$o}})"> <i class="fa fa-plus"></i> Contact</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1" style="margin-left: -20px">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <button class="btn btn-danger btn-rounded btn-sm" style="margin-top:23px"  wire:click.prevent="datesRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="datesAdd({{$g}})"> <i class="fa fa-plus"></i> Date</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

<div>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="fuel_requestDecisionModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-building-o"></i> Approve / Reject Request <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                <form wire:submit.prevent="update()" >
                <div class="modal-body">
                    <div class="form-group">
                        <label for="decision">Decision</label>
                       <select wire:model.debounce.300ms="decision" class="form-control" required>
                   ...
                   <textarea wire:model.debounce.300ms="comments" cols="30" rows="5" class="form-control"></textarea>

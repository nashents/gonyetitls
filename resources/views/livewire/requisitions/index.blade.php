                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            @foreach ($requisition->requisition_items as $item)
                                                {{$item->expense ? $item->expense->name : ""}} @   @if ($item->amount)
                                                {{ $item->requisition->currency ? $item->requisition->currency->symbol : ""}}{{ number_format($item->amount,2)}}
                                            @endif <br>
                                            @endforeach
                                        </td>
                                        <td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" class="form-control" wire:model.defer="qty.0"  required />
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" min="1" class="form-control" wire:model.defer="amount.0" required />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="country">Expenses<span class="required" style="color: red">*</span></label>
                                   <select wire:model.defer="expense_id.{{ $value }}" class="form-control" required >
                                       <option value="">Select Expense</option>
                                       @foreach ($expenses as $expense)
                                       <option value="{{ $expense->id }}">{{ $expense->name }}</option>
                                       @endforeach
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="name">Qty<span class="required" style="color: red">*</span></label>
                                    <input type="number" class="form-control" wire:model.defer="qty.{{ $value }}"  required />
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="name">Amount<span class="required" style="color: red">*</span></label>
                                    <input type="number" step="any" class="form-control" wire:model.defer="amount.{{ $value }}"  required />

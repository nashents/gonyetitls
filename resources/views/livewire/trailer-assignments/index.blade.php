<div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title">
                                <a href="" data-toggle="modal" data-target="#assignmentModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Trailer - Horse Assignment</a>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-plus"></i> Trailer - Horse Assignment <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <select wire:model.debounce.300ms="selectedHorse" class="form-control" required>
                                   ...
                                   @php
                                       $assignments = App\Models\TrailerAssignment::where('status',1)->get();
                                       foreach ($assignments as $assignment) {
                                           $assignment_trailer_ids[] = $assignment->trailer_id;
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="trailer">Trailers<span class="required" style="color: red">*</span></label>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="assignmentEditModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-edit"></i> Trailer - Horse Assignment <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="Trailer">Trailer(s)<span class="required" style="color: red">*</span></label>
                               <select wire:model.debounce.300ms="trailer_id" class="form-control" required>
                                   <option value="" selected>Select Trailer</option>
                                   @foreach ($trailers as $trailer)
                                   <option value="{{$trailer->id}}">{{$trailer->registration_number}} </option>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="unAssignmentModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fas fa-edit"></i>Trailer - Horse Unassignment<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>

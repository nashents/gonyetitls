<div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title">
                                <a href="" data-toggle="modal" data-target="#locationModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Location</a>
                                <a href="" data-toggle="modal" data-target="#locationsImportModal" class="btn btn-default border-primary btn-rounded btn-wide"><i class="fa fa-upload"></i>Import</a>
                                <a href="#" wire:click="exportLocationsExcel()"  class="btn btn-default border-primary btn-rounded btn-wide"><i class="fa fa-download"></i>Excel</a>
                                <a href="#" wire:click="exportLocationsCSV()" class="btn btn-default border-primary btn-rounded btn-wide"><i class="fa fa-download"></i>CSV</a>
                                <a href="#" wire:click="exportLocationsPDF()" class="btn btn-default border-primary btn-rounded btn-wide"><i class="fa fa-download"></i>PDF</a>
                            </div>
                        </div>
                        <div class="panel-body p-20"style="overflow-x:auto; width:100%; height:100%;">
                            <div class="col-md-5" style="float: right; padding-right:2px">
                                <div class="form-group">
                                    <input type="text" wire:model.debounce.300ms="search" class="form-control" placeholder="Search Locations...">
                                </div>
                            </div>
                            <table  class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>  {{$location->lat}}</td>
                                    <td>  {{$location->long}}</td>
                                    <td><span class="badge bg-{{$location->status == 1 ? "success" : "danger"}}">{{$location->status == 1 ? "Active" : "Inactive"}}</span></td>
                                    <td class="w-10 line-height-35 table-dropdown">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#"  wire:click="edit({{$location->id}})" ><i class="fa fa-edit color-success"></i> Edit</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#locationDeleteModal{{ $location->id }}" ><i class="fa fa-trash color-danger"></i>Delete</a></li>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="locationsImportModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">

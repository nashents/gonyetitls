<div>
    {{-- <blockquote class="blockquote-reverse mt-20"> --}}
        ...
        <br>
        <br>
        <table id="transporter_cargosTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th class="th-sm">Type
                </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ucfirst($transporter_cargo->measurement)}}</td>
                <td>{{ucfirst($transporter_cargo->risk)}}</td>
                <td class="w-10 line-height-35 table-dropdown">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#" wire:click="removeShow({{$transporter->id}},{{ $transporter_cargo->id }})"><i class="fa fa-trash color-danger"></i>Remove</a></li>
                        </ul>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-danger">
                    <div class="modal-body">
                       <center> <strong>Are you sure you want to remove this Cargo from Transporter`s Cargo List? </strong> </center>
                    </div>
                        ...
                        <div style="height: 400px; overflow: auto">
                            <div class="form-group">
                                <table  class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%"  style="height: 400px">
                                    <thead>
                                      <tr>
                                        <th class="th-sm">Add Transporter Cargos<span class="required" style="color: red">*</span></th>
                                      </tr>
                                    </thead>
                                    @if ($cargos->count()>0)
                                    <tbody>

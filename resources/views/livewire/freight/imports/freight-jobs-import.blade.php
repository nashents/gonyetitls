                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5>Import Freight Jobs</h5>
                                <small style="color: green">Bulk-migrate open/backlog freight jobs from Excel. Each row creates one Freight Job with its first Shipment. Unresolvable customers/currencies/countries are skipped and reported below.</small>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            @if ($summary)
                                <div class="alert {{ $summary['rows_skipped'] ? 'alert-warning' : 'alert-success' }} mt-20">
                                    {{ $summary['rows_created'] }} freight job(s) imported, {{ $summary['rows_skipped'] }} row(s) skipped.
                                </div>
                            @endif

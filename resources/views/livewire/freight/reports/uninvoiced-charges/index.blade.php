                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5>Uninvoiced Freight Charges Aging</h5>
                                <small style="color: green">Approved customer charge lines not yet turned into an Invoice.</small>
                            </div>
                        </div>
                            ...
                            <div class="row hidden-print">
                                <div class="col-md-12 text-center">
                                    ...
                                    <div class="btn-group" style="margin-left: 25px">
                                        <a href="{{ route('freight.reports.uninvoiced_charges.print', ['as_of_date' => $as_of_date, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                            <i class="fa fa-print"></i> Print
                                        </a>
                                        <a href="{{ route('freight.reports.uninvoiced_charges.pdf', ['as_of_date' => $as_of_date, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="row text-center">
                                        @foreach (\App\Services\Freight\UninvoicedChargesAgingCalculator::BUCKETS as $bucket)
                                        <div class="col-md-2">
                                            <h5>{{$bucket}}</h5><br>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <div class="col-xs-5 p-n"><strong>CUSTOMERS</strong></div>

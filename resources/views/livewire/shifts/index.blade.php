                            ...
                            <table  class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td></td>
                                    <td><span class="badge bg-{{$shift->status == 1 ? "success" : "danger"}}">{{$shift->status == 1 ? "Active" : "Inactive"}}</span></td>
        ...
        <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" wire:model.debounce.300ms="shift_start_time" placeholder="Enter Shift Start Time" required/>
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" wire:model.debounce.300ms="shift_end_time" placeholder="Enter Shift End Time" required/>
                    ...
                    <div class="row">
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="name">Depart Workshop<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="depart_workshop_time" placeholder="Enter Depart Workshop Time" required/>
                                @error('depart_workshop_time') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="name">Arrive Worksite Time<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="arrive_location_time" placeholder="Enter Arrival Worksite Time" required/>
                                @error('arrive_location_time') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="name">Depart Worksite Time<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="depart_location_time" placeholder="Enter Depart Worksite Time" required/>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                                <label for="name">Arrive Worksite Time<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="arrive_workshop_time" placeholder="Enter Arrival Workshop Time" required/>
                    ...
                    <div class="row">
                         <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Close Time<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="stop_time.0" placeholder="Enter Close Time" required/>
                                @error('stop_time.0') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                         <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Close Hours<span class="required" style="color: red">*</span></label>
                                <input type="text" class="form-control" wire:model.debounce.300ms="close_hours.0" placeholder="Enter Close Engine Hours" required/>
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" class="form-control" wire:model.debounce.300ms="close_mileage.0" placeholder="Enter Close Mileage" required/>
                    ...
                    <div class="row">
                         <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Close Time<span class="required" style="color: red">*</span></label>
                                <input type="time" class="form-control" wire:model.debounce.300ms="stop_time.{{$value}}" placeholder="Enter Close Time" required/>
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Close Hours<span class="required" style="color: red">*</span></label>
                                <input type="text" class="form-control" wire:model.debounce.300ms="close_hours.{{$value}}" placeholder="Enter Close Engine Hours" required/>
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="name">Close Mileage</label>
                                <input type="number" step="any" class="form-control" wire:model.debounce.300ms="close_mileage.{{$value}}" placeholder="Enter Close Mileage" required/>
                    ...
                    @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="odometer">Mileage<span class="required" style="color: red">*</span></label>
                                        <input type="number" step="any" class="form-control" wire:model.debounce.300ms="mileage" required placeholder="Enter Mileage" required/>

                ...
                <main>
                    <div class="row contacts">
                        {{-- <div class="col invoice-to" >
                            <div class="text-gray-light">Filter(s)</div>
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title" >
                                        <div class="col-xs-5 p-n">
                                            <div class="text-gray-light">Total Trip(s): <strong>{{$shift->sum('total_loads')}}</strong></div>
                                            <div class="text-gray-light">Total Fuel Usage: <strong>{{$shift->sum('total_fuel')}}</strong></div>
                                            {{-- <div class="text-gray-light">AVG Fuel Consumption: <strong>{{$total_fuel ? $total_fuel." Litres" : ""}}</strong></div> --}}
                                        </div>
                                    </div>
                                </div>

                                                        ...
                                                        <tbody>
                                                           ...
                                                           <tr>
                                                                ...
                                                                <td>
                                                                    @php
                                                                        ...
                                                                        if ($trip->trip_transport_orders && $trip->trip_transport_orders->count()) {
                                                                            ...
                                                                            $customers = $trip->trip_transport_orders
                                                                    ...
                                                                    @forelse($customers as $customer)
                                                                        ...
                                                                        @if(!$loop->last && $customers->count() > 1)
                                                                            <hr class="my-1">
                                                                        @endif
                                                                    @empty
                                                                        -
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($trip->horse)
                                                                    Horse | <a href="{{ route('horses.show',$trip->horse->id) }}" style="color:blue">  {{ $trip->horse->identifier_label }}    {{$trip->horse->horse_make ? $trip->horse->horse_make->name : "" }} {{$trip->horse->horse_model ? $trip->horse->horse_model->name : "" }} </a>
                                                                    @elseif($trip->vehicle)
                                                                    Vehicle | <a href="{{ route('vehicles.show',$trip->vehicle->id) }}" style="color:blue"> {{ $trip->vehicle->identifier_label }}  {{$trip->vehicle->vehicle_make ? $trip->vehicle->vehicle_make->name : "" }} {{$trip->vehicle->vehicle_model ? $trip->vehicle->vehicle_model->name : "" }} </a>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @php
                                                                                ...
                                                                                if ($trip->trip_transport_orders && $trip->trip_transport_orders->count()) {
                                                                                    ...
                                                                                    $cargos = $trip->trip_transport_orders
                                                                                        ->map(function ($trip_transport_order) {
                                                                                            $to = $trip_transport_order->transport_order;
                                                                                    ...
                                                                                    if ($trip->cargo) {
                                                                                        $cargos = collect([
                                                                                            [
                                                                                                'id'   => $trip->cargo->id,
                                                                                                'name' => $trip->cargo->name,
                                                                                                'key'  => md5($trip->cargo->id),
                                                                                            ]
                                                                                        ]);
                                                                                    }
                                                                                }

                                    ...
                                    <tbody>
                                      ...
                                      <tr style="background-color: #5cb85c">
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            @if ($trip->horse)
                                                Horse | {{ucfirst($trip->horse->horse_make ? $trip->horse->horse_make->name : "")}} {{ucfirst($trip->horse->horse_model ? $trip->horse->horse_model->name : "")}} {{ $trip->horse ? $trip->horse->identifier_label : "" }}
                                            @elseif ($trip->vehicle)
                                         ...
                                         <td class="w-10 line-height-35 table-dropdown">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                     <li><a href="#" wire:click.prevent="showRestore({{$trip->id}})" ><i class="fa fa-refresh color-default"></i>Restore</a></li>
                                                </ul>
                                            </div>

    ...
    <div id="invoice">
        <div class="toolbar hidden-print">
            <div class="text-end">
               ...
               <a href="{{ route('trips.summary.range.print',['from' => $from, 'to' => $to,'trip_filter'=>$trip_filter]) }}" class="btn btn-secondary" ><i class="fa fa-print"></i> Print</a>
                @elseif (isset($from) && isset($to) && isset($search))
                    <a href="{{ route('trips.summary.all.print',['from' => $from, 'to' => $to, 'search' => $search,'trip_filter'=>$trip_filter]) }}" class="btn btn-secondary" ><i class="fa fa-print"></i> Print</a>
                @elseif (isset($search))
                <a href="{{ route('trips.summary.search.print',['search' => $search,'trip_filter'=>$trip_filter]) }}" class="btn btn-secondary" ><i class="fa fa-print"></i> Print</a>
                @else
                <a href="{{ route('trips.summary.print',['trip_filter'=>$trip_filter]) }}" class="btn btn-secondary" ><i class="fa fa-print"></i> Print</a>
                @endif
            </div>
            <hr>
        </div>

<div>
    {{-- resources/views/livewire/trips/trip-status-manager.blade.php --}}
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="update">
                    <div class="modal-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @if (isset($starting_mileage))
                                        <input type="number" step="any" min="{{ $starting_mileage }}"
                                               class="form-control"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @if (isset($starting_hours))
                                        <input type="number" step="any" min="{{ $starting_hours }}"
                                               class="form-control"
                                ...
                                @if (in_array($selectedStatus, ['Loaded', 'Offloaded']))
                                    <div class="card mb-3 border">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @include('livewire.trips.partials.tto-loading-fields', compact('ttoId','cargo_type','units_of_measures','canEditRates','hasTransporter'))
                                            @if ($selectedStatus === 'Offloaded')
                                                @include('livewire.trips.partials.tto-offloading-fields', compact('ttoId','cargo_type','units_of_measures','canEditRates','hasTransporter'))
                                            @endif
                                        </div>
                                    </div>
                                @endif
                        ...
                        {{-- ============================================================ --}}
                        {{-- PATH B — LEGACY: single delivery note flat fields            --}}
                        {{-- ============================================================ --}}
                        @elseif (! $useTtoPath && in_array($selectedStatus, ['Loaded', 'Offloaded']))
                            ...
                            @php
                                ...
                                $hasTransporter    = $trip?->transporter_agreement == true;
                            @endphp

                            <div class="card mb-3 border">
                                <div class="card-header bg-light py-2">
                                    <strong><i class="fas fa-truck mr-1"></i> Loading / Offloading Details</strong>
                                    @if ($cargo_type)
                                        <span class="badge badge-secondary ml-2">{{ $cargo_type }}</span>
                                    @endif
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control"
                                                       ...
                                                       required>
                                                @error('loaded_date') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Weight @if ($cargo_type === 'Solid') <span class="text-danger">*</span> @endif</label>
                                                <input type="number" step="any" class="form-control"
                                                       wire:model.debounce.300ms="loaded_weight"
                                                       placeholder="Loading weight"
                                                       {{ $selectedStatus === 'Offloaded' ? 'disabled' : '' }}
                                                       {{ $cargo_type === 'Solid' ? 'required' : '' }}>
                                                @error('loaded_weight') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" class="form-control"
                                                       ...
                                                       required>
                                                @error('loaded_rate') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" class="form-control"
                                                       ...
                                                       {{ ($selectedStatus === 'Offloaded' || !$canEditRates) ? 'disabled' : '' }}
                                                       required>
                                                @error('loaded_freight') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control"
                                                           ...
                                                           required>
                                                    @error('offloaded_date') <span class="text-danger small">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Unit of Measure</label>
                                                        <select class="form-control"
                                                                wire:model.debounce.300ms="units_of_measure_id" disabled>
                                                            <option value="">Select UOM</option>
                                                            @foreach ($units_of_measures as $uom)
                                                                <option value="{{ $uom->id }}">{{ $uom->name }}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="any" class="form-control"
                                                               ...
                                                               placeholder="Litreage @ 20°C" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control"
                                                           ...
                                                           required>
                                                    @error('offloaded_rate') <span class="text-danger small">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control"
                                                           ...
                                                           {{ !$canEditRates ? 'disabled' : '' }}
                                                           required>
                                                    @error('offloaded_freight') <span class="text-danger small">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                        </div>

                                            ...
                                            <div class="row hidden-print">
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <div class="btn-group" style="margin-left: 25px">
                                                        <a href="{{ route('reports.purchase_by_vendor.print', ['from' => $from, 'to' => $to, 'type' => $selectedType, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                                            <i class="fa fa-print"></i> Print
                                                        </a>
                                                        <a href="{{ route('reports.purchase_by_vendor.pdf', ['from' => $from, 'to' => $to, 'type' => $selectedType, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                                ...
                                                <div class="col-md-8 col-md-offset-2">
                                                    <div class="row text-center">
                                                        <div class="col-md-6">
                                                            ...
                                                            <br>
                                                            <h4 style="margin-top:-15px" class="{{ $total_purchases < 0 ? 'text-danger' : '' }}">{{$default_currency->name}} {{$default_currency->symbol}}{{$this->fmt($total_purchases)}}</h4>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <h5>Vendors with Purchases</h5>
                                                            <br>
                                                            <h4 style="margin-top:-15px">{{ count($vendor_items) }}</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body ">
                                            ...
                                            <div class="col-xs-12 p-n" style="background-color: #D3D3D3">
                                                <div class="col-xs-5 p-n">
                                                    <strong><span style="margin-left:5px">Total Purchases</span></strong>
                                                </div>
                                                <div class="col-xs-6 p-n">
                                                <span style="float: right">{{$default_currency->name}} {{$default_currency->symbol}}{{$this->fmt($total_purchases)}}</span>
                                                </div>
                                            </div>

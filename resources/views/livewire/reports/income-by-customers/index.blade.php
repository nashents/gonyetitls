                                            ...
                                            <div class="row hidden-print">
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <div class="btn-group" style="margin-left: 25px">
                                                        <a href="{{ route('reports.income_by_customer.print', ['from' => $from, 'to' => $to, 'type' => $selectedType, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                                            <i class="fa fa-print"></i> Print
                                                        </a>
                                                        <a href="{{ route('reports.income_by_customer.pdf', ['from' => $from, 'to' => $to, 'type' => $selectedType, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-md-offset-2">
                                                    <div class="row text-center">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h5>Customers with Income</h5>
                                                            <br>
                                                            <h4 style="margin-top:-15px">{{ count($customer_items) }}</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

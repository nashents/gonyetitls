                                            ...
                                            <div class="row hidden-print">
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <div class="btn-group" style="margin-left: 25px">
                                                        <a href="{{ route('reports.aged_receivables.print', ['as_of_date' => $as_of_date, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                                            <i class="fa fa-print"></i> Print
                                                        </a>
                                                        <a href="{{ route('reports.aged_receivables.pdf', ['as_of_date' => $as_of_date, 'view' => $this->viewMode()]) }}" target="_blank" class="btn btn-default btn-wide btn-rounded">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10 col-md-offset-1">
                                                    <div class="row text-center">
                                                        @foreach (\App\Services\AgedReceivablesCalculator::BUCKETS as $bucket)
                                                        <div class="col-md-2">
                                                            <h5>{{$bucket}}</h5>
                                                            <br>

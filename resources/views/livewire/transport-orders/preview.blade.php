    ...
    <div id="invoice">
        <div class="toolbar hidden-print">
            <div class="text-end">
                ...
                <a href="{{route('transport_orders.print',$trip->id)}}" class="btn btn-default border-primary btn-wide btn-rounded"><i class="fa fa-print" style="color:black"></i> Print</a>
                <a href="{{route('transport_orders.pdf', $trip->id)}}" class="btn btn-default border-primary btn-wide btn-rounded"><i class="fa fa-file-pdf-o" style="color: red"></i> Export as PDF</a>
            </div>
            <hr>
        </div>

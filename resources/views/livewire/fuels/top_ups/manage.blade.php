        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="vendors">Fuel Supplier</label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" step="any" min="0" required="required" wire:model.debounce.300ms="unit_price" placeholder="Enter Pump Price/Litre" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="any" class="form-control" required="required" wire:model.debounce.300ms="quantity" placeholder="Enter Fillup Quantity" required disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" required="required" wire:model.debounce.300ms="amount" disabled required>

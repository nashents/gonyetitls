<div>
    ...
    {{-- <blockquote class="blockquote-reverse mt-20"> --}}
        @if ($vehicle_images->count()>0)
        @foreach ($vehicle_images as $image)
        <div class="col-md-4">
            <a href="{{asset('images/uploads/'.$image->filename)}}"><img src="{{asset('images/uploads/'.$image->filename)}}" alt="Vehicle Avatar" class="img-responsive" style="width:100% ; height:100% ;"></a>
        </div>
        @endforeach
        @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-image"></i> Add Vehicle Images(s) <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>

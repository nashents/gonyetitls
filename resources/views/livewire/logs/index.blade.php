            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.debounce.300ms="searchVehicle" placeholder="Search Using: Vehicle Reg#, Vehicle Make, Vehicle Model..." class="form-control" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if (!is_null($ending_mileage) && !is_null($starting_mileage))
                                    @if ($ending_mileage < $starting_mileage)
                                        <small style="color: red" >Ending mileage cannot be less than Starting mileage</small>
                                    @endif
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Starting Mileage Image<span class="required" style="color: red">*</span></label>
                                <input type="file" step="any" class="form-control" wire:model.debounce.300ms="starting_mileage_image" placeholder="Upload Image" required />
                                @error('starting_mileage_image') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Ending Mileage Image</label>
                                <input type="file"  class="form-control" wire:model.debounce.300ms="ending_mileage_image" placeholder="Upload Image"  />
                                @error('ending_mileage_image') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                     </div>
                        <div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Starting Mileage Image<span class="required" style="color: red">*</span></label>
                                <small>Selected Image:</small><img src="{{ asset('images/uploads/'.$selected_starting_mileage_image) }}" style="width:50%; height:50%" alt="">
                                <input type="file" step="any" class="form-control" wire:model.debounce.300ms="starting_mileage_image" placeholder="Upload Image" required />
                                @error('starting_mileage_image') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Ending Mileage Image</label>
                                <small>Selected Image:</small><img src="{{ asset('images/uploads/'.$selected_ending_mileage_image) }}" style="width:50%; height:50%" alt="">
                                <input type="file"  class="form-control" wire:model.debounce.300ms="ending_mileage_image" placeholder="Upload Image"  />
                                @error('ending_mileage_image') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @error('ending_mileage') <span class="error" style="color:red">{{ $message }}</span> @enderror
                                @if (isset($ending_mileage) && ($ending_mileage < $starting_mileage))
                                    <small style="color: red" >Ending mileage cannot be less than Starting mileage</small>
                                @endif

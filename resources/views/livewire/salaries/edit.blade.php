                    ...
                    <div class="panel">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                               ...
                               <select wire:model.debounce.300ms="selectedEmployee" class="form-control" required disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-success btn-rounded btn-sm" style="float: right" wire:click.prevent="loansAdd({{$j}})"> <i class="fa fa-plus"></i>Loan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

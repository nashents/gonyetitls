<div>
    <div class="col-md-3">
        ...
        <div class="panel border-primary no-border border-3-top">
            <div class="panel-heading">
                <div class="panel-title">
                  <center> <h5>{{ $trailer->identifier_label }}</h5></center>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="tab-content bg-white p-15">
            ...
            <div role="tabpanel" class="tab-pane" id="fitness">
                @livewire('fitnesses.index', ['id' => $trailer->id, 'type' => "Trailer"])
                   </div>

            <div role="tabpanel" class="tab-pane" id="tyres">
                @livewire('tyres.tyre-assignments', ['id' => $trailer->id, 'type' => "Trailer"])
            </div>

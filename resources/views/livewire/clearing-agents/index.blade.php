<div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title">
                                <a href="" data-toggle="modal" data-target="#clearing_agentModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Clearing Agent</a>
                            </div>
                        </div>
                        <div class="panel-body p-20"style="overflow-x:auto; width:100%; height:100%;">
                            <table id="clearing_agentsTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                <thead>
                                  <tr>

                                    <th class="th-sm">Clearing Agent#
                                    </th>
                                    <th class="th-sm">Name
                                    </th>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{$clearing_agent->country}}</td>
                                    <td>{{$clearing_agent->city}}</td>
                                    <td>
                                        @if (isset($clearing_agent->suburb) || isset($clearing_agent->street_address))
                                             {{$clearing_agent->suburb}}, {{$clearing_agent->street_address}}        
                                        @endif
                                    </td>
                                    <td><span class="badge bg-{{$clearing_agent->status == 1 ? "success" : "danger"}}">{{$clearing_agent->status == 1 ? "Active" : "Inactive"}}</span></td>
                                    <td class="w-10 line-height-35 table-dropdown">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="{{ route('clearing_agents.show', $clearing_agent->id) }}"  ><i class="fa fa-eye color-default"></i> View</a></li>
                                                <li><a href="#"  wire:click="edit({{$clearing_agent->id}})" ><i class="fa fa-edit color-success"></i> Edit</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#clearing_agentDeleteModal{{ $clearing_agent->id }}" ><i class="fa fa-trash color-danger"></i>Delete</a></li>
                                            </ul>
                                        </div>
                                        @include('clearing_agents.delete')
                                </td>
                                  </tr>
                                  @endforeach
                                </tbody>
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="clearing_agentModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-plus"></i> Add Clearing Agent <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Border(s)<span class="required" style="color: red">*</span></label>
                               <select wire:model.debounce.300ms="border_id.0" class="form-control" required>
                                ...
                                @foreach ($borders_inputs as $key => $value)
                                <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                       <select wire:model.debounce.300ms="border_id.{{ $value }}" class="form-control" required>
                                        <option value="">Select Border</option>
                                            @foreach ($borders as $border)
                                                <option value="{{ $border->id }}">{{ $border->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-md-1">
                                    <div class="form-group" style="margin-top: -24px;">
                                        <label for=""></label>
                                        <button class="btn btn-danger btn-rounded xs" style="margin-top:23px"  wire:click.prevent="bordersRemove({{$key}})"> <i class="fa fa-times"></i></button>
                                    </div>
                                </div>
                                 </div>    
                                @endforeach
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button class="btn btn-success btn-rounded" style="float: right" wire:click.prevent="bordersAdd({{$z}})"> <i class="fa fa-plus"></i> Border</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" wire:model.debounce.300ms="town" placeholder="Enter City/Town"  />
    ...
    <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="clearing_agentEditModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fa fa-edit"></i> Edit Clearing Agent <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                </div>

<div>
    {{-- <blockquote class="blockquote-reverse mt-20"> --}}
        <x-loading/>
        <a href="" data-toggle="modal" data-target="#asset_documentsModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Document</a>
        <br>
        <br>
        <table id="asset_documentsTable" class="table  table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
            <thead >
                ...
                <td class="w-10 line-height-35 table-dropdown">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#" wire:click="edit({{$asset_document->id}})"><i class="fa fa-edit color-success"></i> Edit</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#assetProductDeleteModal{{$asset_document->id}}"><i class="fa fa-trash color-danger"></i>Delete</a></li>
                        </ul>
                    </div>
                    @include('asset_documents.delete')
          ...
          <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="asset_documentsModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal4Label"><i class="fas fa-file"></i> Upload Document<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select wire:model.debounce.300ms="title.0" class="form-control">
                                        ...
                                        <option value="asset_document 1">asset_document 1</option>
                                        <option value="asset_document 2">asset_document 2</option>
                                        <option value="asset_document 3">asset_document 3</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="Product">Attach Document</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="Product">Attach asset_document</label>
                                        <input type="file"  class="form-control" wire:model.debounce.300ms="file.{{$value}}"  placeholder="Upload asset_document ">
          ...
          <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="asset_documentsEditModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal4Label"><i class="fas fa-file"></i> Edit Document<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select wire:model.debounce.300ms="title" class="form-control">
                                <option value="">Select Title</option>
                                <option value="asset_document 1">Quotation 1</option>
                                <option value="asset_document 2">Quotation 2</option>
                                <option value="asset_document 3">Quotation 3</option>
                                  <option value="Invoice">Invoice</option>
                                  <option value="Receipt">Receipt</option>
                            </select>

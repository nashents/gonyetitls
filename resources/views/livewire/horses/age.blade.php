                        ...
                        <div class="panel-body p-20"style="overflow-x:auto; width:100%; height:100%;">
                            ...
                            <table id="horsesTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  if (isset($horse->year)) {
                                        $current_year = date('Y');
                                        if ((isset($current_year) && is_numeric($current_year)) && (isset($horse->year) && is_numeric($horse->year)) ) {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal4Label"><i class="fas fa-plus"></i> 
                        Update @if (isset($horse))

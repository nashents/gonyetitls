                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="mb-10">
                                                    <input type="radio" wire:model="bill_attached" value="Yes" class="line-style" id="bill_attached_yes" />
                                                    <label for="bill_attached_yes" class="radio-label">Yes</label>
                                                    <input type="radio" wire:model="bill_attached" value="No" class="line-style" id="bill_attached_no" />
                                                    <label for="bill_attached_no" class="radio-label">No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

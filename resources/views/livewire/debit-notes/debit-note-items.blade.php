<div>
        ...
        <a href="" data-toggle="modal" data-target="#adddebit_noteItemModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Debit Note Item</a>
        <br>
        @endif

        <br>
        <table id="debit_note_itemsTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th class="th-sm">DebitNote#
                </th>
                <th class="th-sm">Item
                </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    @if ($debit_note_item->debit_note)
                    {{$debit_note_item->debit_note->currency ? $debit_note_item->debit_note->currency->name : ""}}
                    @endif
                </td>
                <td>
                    @if ($debit_note_item->debit_note)
                        @if ($debit_note_item->amount)
                        {{$debit_note_item->debit_note->currency ? $debit_note_item->debit_note->currency->symbol : ""}}{{number_format($debit_note_item->amount,2)}}
                        @endif
                    @endif
                </td>
                <td>
                    @if ($debit_note_item->debit_note)
                        ...
                        {{$debit_note_item->debit_note->currency ? $debit_note_item->debit_note->currency->symbol : ""}}{{number_format($debit_note_item->subtotal,2)}}
                        @endif
                    @endif
                </td>
                <td class="w-10 line-height-35 table-dropdown">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                                ...
                                @if ($debit_note->authorization != "approved")
                                <li><a href="#" wire:click="edit({{$debit_note_item->id }})"><i class="fa fa-edit color-success"></i>Edit</a></li>
                                <li><a href="#" wire:click="removeShow({{ $debit_note_item->id }})"><i class="fa fa-trash color-danger"></i>Delete</a></li>
                                @endif
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-danger">
                    <div class="modal-body">
                       <center> <strong>Are you sure you want to delete this Debit Note Item</strong> </center>
                    </div>
                    <form wire:submit.prevent="removeDebitNoteItem()" >
        ...
        <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="adddebit_noteItemModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
            <div class="modal-dialog" role="cargo">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal4Label"><i class="fa fa-file-invoice"></i> Add Debit Note Item(s) <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                    </div>
        ...
        <div wire:ignore.self data-backdrop="static" data-keyboard="false" class="modal" id="editDebit_noteItemModal" tabindex="-1" role="dialog" aria-labelledby="modal4Label" data-backdrop-color="blue">
            <div class="modal-dialog" role="cargo">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal4Label"><i class="fa fa-file-invoice"></i> Edit Debit Note Item <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
                    </div>

...
@endsection
@section('title')
    Tax Bracket | @if (isset(Auth::user()->employee->company))
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active"> <i class="fa fa-list"></i> Tax Table</li>
            						</ul>
                                </div>
                                <!-- /.col-md-6 -->

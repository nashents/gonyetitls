<div data-backdrop="static" data-keyboard="false" class="modal fade" id="quotation_productDeleteModal{{ $quotation_product->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Quotation Item</strong> </center>
            </div>
            <form action="{{route('quotation_products.destroy', $quotation_product->id)}}" method="POST" >
                {{ csrf_field() }}

<div data-backdrop="static" data-keyboard="false" class="modal fade" id="bill_expenseDeleteModal{{ $bill_expense->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Bill Expense</strong> </center>
            </div>
            <form action="{{route('bill_expenses.destroy', $bill_expense->id)}}" method="POST" >
                {{ csrf_field() }}

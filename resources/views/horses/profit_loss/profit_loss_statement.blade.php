                        ...
                        <main>
                            <div class="row contacts">
                                ...
                                <div class="col invoice-details">
                                    ...
                                    <div class="date" style="padding-bottom: 3px"><strong>From: </strong> {{Carbon\Carbon::parse($this->from)->format('d F Y')}} </div> 
                                    <div class="date" style="padding-bottom: 3px"><strong>To: </strong> {{Carbon\Carbon::parse($this->to)->format('d F Y')}} </div> 
                                </div>
                            </div> 
                                        ...
                                        <div class="panel-heading">
                                            <div class="panel-title" >
                                                <div class="col-xs-5 p-n">
                                                    <div class="text-gray-light">Total Trip(s): <strong>{{$this->total_trips}}</strong></div>
                                                    <div class="text-gray-light">Total Fuel Order(s): <strong>{{$this->total_fuel_orders}}</strong></div>
                                                    <div class="text-gray-light">Total Fuel Usage: <strong>{{$this->total_fuel ? $this->total_fuel." Litres" : ""}}</strong></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body ">
                                            ...
                                            <div class="col-xs-12 p-n">
                                                <div class="col-xs-5 p-n">
                                                    ...
                                                    <span style="float: right; ">{{$default_currency->name}} {{$default_currency->symbol}}{{number_format($this->total_income ? $this->total_income : 0,2)}}</span>
                                                </div>
                                            </div>
                                            ...
                                            @foreach ($cost_of_goods_sold_accounts as $account)
                                                @php
                                                        ...
                                                        ->whereHas('bill', function($q){
                                                            $q->where('horse_id', $selectedHorse);
                                                        })
                                                        ->get();
                                                        ...
                                                        if (is_numeric($account_cost_of_goods_sold) && is_numeric($account_exchange_cost_of_goods_sold)) {
                                                            $this->total_account_cost_of_goods_sold =  $account_cost_of_goods_sold + $account_exchange_cost_of_goods_sold;
                                                        }
                                                ...
                                                @if (isset($account_bill_expenses) && $account_bill_expenses->count() > 0)
                                                    <div class="col-xs-12 p-n">
                                                        ...
                                                        <span style="float: right">{{$default_currency->name}} {{$default_currency->symbol}}{{number_format($this->total_account_cost_of_goods_sold ? $this->total_account_cost_of_goods_sold : 0,2)}}</span>
                                                        </div>
                                                    </div>
                                                    <hr style="width:100%;", size="3", color=black> 
                                                @endif
                                            ...
                                            <div class="col-xs-6 p-n" >
                                                <strong><span style="float: right; margin-top: -55px;">{{$default_currency->name}} {{$default_currency->symbol}}{{number_format($gross_profit ? $gross_profit : 0,2)}}</span></strong>
                                                <br>
                                                <p>
                                            ...
                                            @foreach ($operating_expenses_accounts as $account)
                                                    ...
                                                    $account_bill_expenses = App\Models\BillExpense::where('account_id',$account->id)
                                                        ...
                                                        if (is_numeric($account_operating_expenses) && is_numeric($account_exchange_operating_expenses)) {
                                                            $this->total_account_operating_expenses =  $account_operating_expenses + $account_exchange_operating_expenses;
                                                        }
                                                    @endphp
                                                    @if (isset($account_bill_expenses) && $account_bill_expenses->count() > 0)
                                                        <div class="col-xs-12 p-n">
                                                            <div class="col-xs-5 p-n">
                                                                <span style="margin-left:5px">{{$account->name}}</span> 
                                                                <span style="float: right">{{$default_currency->name}} {{$default_currency->symbol}}{{ number_format($this->total_account_operating_expenses ? $this->total_account_operating_expenses : 0,2)}}</span>
                                                            </div>
                                            ...
                                            <div class="col-xs-12 p-n" style="background-color: #D3D3D3; ">
                                                ...
                                                <div class="col-xs-6 p-n"  >
                                                    <strong><span style="float: right; margin-top: -55px;">{{$default_currency->name}} {{$default_currency->symbol}}{{number_format($net_profit ? $net_profit : 0,2)}}</span></strong>
                                                    <br>
                                                    <p>
                                                        <span style="float: right; margin-top: -55px;">

...
Route::get('trip-edit-authorizers/pending', 'TripEditAuthorizerController@pending')->name('trip_edit_authorizers.pending');
Route::get('trip-edit-authorizers', 'TripEditAuthorizerController@index')->name('trip_edit_authorizers.index');
